...
export default function SymptomsPage({ symptoms, onRefresh }) {
    ...
    <>
      <div className="bg-white rounded-xl shadow-lg p-6">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-lg font-bold">Kelola Data Gejala</h3>
          <button
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-sm font-semibold">Nama Gejala</th>
